...
public class Bee implements Runnable
{
    ...
    */
    ...
    public void run ()
    {
	while (active && !Global.gameOver)
	{
	    // If it is Bee's turn, makes a move.
	    if (Global.playerturn == team)
	    {
	    Point lastMove;
		...
		if (lastMove == null)
		{
		    ...
		    BeeMove.move = new Point(pieces.length / 2 - 1, pieces.length / 2 - 1);
		}
		...
		else
		{
		    ...
		    if(x>=0 && y>=0) BeeMove.move = new Point(y, Global.gridSize-1-x);
		    System.out.println("My move: "+BeeMove.move);
		}
	    }
